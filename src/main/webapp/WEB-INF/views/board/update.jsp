...
<form id="form" class="topBefore" action="update" method="post">
		 <input type="hidden" name="page" value="${page }">
		 
		  <div>
    
      <p>문의 번호 : ${vo.boardNo }</p>
      <input id="boardno" type="hidden" name="boardNo" value="${vo.boardNo }">
    </div>
    	  <p id="name" >NAME ${vo.userId }</p>
		  <input id="email" type="text" name="boardTitle" placeholder="TITLE" value="${vo.boardTitle }" required="required">
		  <textarea id="message" type="text" name="boardContent" placeholder="MESSAGE"  required="required">${vo.boardContent }</textarea>
